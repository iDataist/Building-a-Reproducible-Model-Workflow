...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Artifact containing the training dataset. It will be split into"
    ...
    parser.add_argument(
        ...
        type=float,
        help=(
            "Size of the validation split. Fraction of the dataset, or number"
            " of items"
        ),
    )
    ...
    parser.add_argument(
        "--rf_config",
        help=(
            "Random forest configuration. A JSON dict that will be passed to"
